...
using Pokemon.Core.Effects;
using Pokemon.Core.Localization;
using Pokemon.Core.Settings;
using Pokemon.ScreenManagers;
...
namespace Pokemon.Core
{
    ...
    public class PokemonGame : Game
    {
        ...
        private SettingsManager<PokemonSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<PokemonLeaderboard> leaderboardManager;
        ...
        public PokemonGame()
        {
            ...
            settingsManager = new SettingsManager<PokemonSettings>(storage);
            Services.AddService(typeof(SettingsManager<PokemonSettings>), settingsManager);

            leaderboardManager = new SettingsManager<PokemonLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<PokemonLeaderboard>), leaderboardManager);
